...
//                BindGrid: 'BindGrid',
                onchange: null,
                onload: null, // load grid
                controlsalways: false
            }, options);
            return this.each(function () {
//                var BindGrid = null;
//                if (settings.BindGrid)
//                    BindGrid = settings.BindGrid;
                //debugger;
                var currentPage = settings.currentIndex;
                initval = currentPage;
                ...
                function navigate(topage) {
                    ...
                    if (topage >= 0 && topage < totalpages) {
                        ...
                        if (settings.OnPageIndexChanging)
                            settings.OnPageIndexChanging(topage);
