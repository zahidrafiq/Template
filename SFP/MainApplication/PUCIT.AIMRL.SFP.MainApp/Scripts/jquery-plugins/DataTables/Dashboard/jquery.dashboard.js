...
(function ($) { // Create closure.
    ...
    $.fn.dashboard = function (options) {
        ...
        dashboard.loadLayout = function () {
            ...
            if (typeof opts.json_data.url != 'undefined' && opts.json_data.url.length > 0) {
                ...
                MyWebApp.Globals.MakeAjaxCall("GET", opts.json_data.url, {}, function (json) {
                    //debugger;
    ...
    $.fn.dashboard.defaults = {
        debuglevel: 3,
        json_data: {},
        loadingHtml: '<div class="loading"><img alt="Loading, please wait" src="../../../project/Content/Dashboard/themes/default/loading.gif" /><p>Loading...</p></div>',
